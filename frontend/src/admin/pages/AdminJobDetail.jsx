            ...
            <div className="bg-surface-container-lowest rounded-xl p-6 shadow-[2px_2px_6px_rgba(163,177,198,0.4),-2px_-2px_6px_rgba(255,255,255,0.9)] flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
              <div>
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <span className="px-2.5 py-1 rounded-full bg-status-success/10 text-status-success border border-status-success/30 font-data-sm text-xs font-bold flex items-center">
                    <span className="w-1.5 h-1.5 rounded-full bg-status-success mr-1.5"></span> Verified Active
                  </span>
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
              ...
              <div className="lg:col-span-8 space-y-6">
                <div className="bg-surface-container-lowest rounded-xl p-6 shadow-[2px_2px_6px_rgba(163,177,198,0.4),-2px_-2px_6px_rgba(255,255,255,0.9)]">
                  ...
                  <div className="prose max-w-none text-body-md text-on-surface leading-relaxed whitespace-pre-line bg-surface-bright p-6 rounded-xl border border-outline-variant/20 shadow-[inset_2px_2px_5px_rgba(163,177,198,0.2)]">
                    {job.description || 'No extended text description provided for this listing.'}
                  </div>
                </div>
              </div>
            </div>
