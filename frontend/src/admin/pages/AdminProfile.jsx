        ...
        <div className="lg:col-span-8 bg-surface-container-lowest rounded-xl p-6 shadow-[2px_2px_6px_rgba(163,177,198,0.4),-2px_-2px_6px_rgba(255,255,255,0.9)] flex flex-col sm:flex-row gap-6 items-start sm:items-center">
          ...
          <div className="flex-1">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-4">
              ...
              <div className="flex items-center gap-2 bg-status-success/10 px-3 py-1.5 rounded-full border border-status-success/30">
                <span className="w-2 h-2 rounded-full bg-status-success animate-pulse"></span>
                <span className="font-data-sm text-xs font-bold text-status-success">Authenticated</span>
              </div>
            </div>

            <div className="grid grid-cols-2 gap-4 mt-4 pt-4 border-t border-outline-variant/30 font-data-sm text-xs">
              <div>
                <span className="block text-secondary mb-0.5">Role Level</span>
                <span className="font-bold text-on-surface">Super Administrator</span>
              </div>
              <div>
                <span className="block text-secondary mb-0.5">Scope</span>
                <span className="font-bold text-on-surface">Full System Access</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="lg:col-span-4 bg-surface-container-lowest rounded-xl p-6 shadow-[2px_2px_6px_rgba(163,177,198,0.4),-2px_-2px_6px_rgba(255,255,255,0.9)] flex flex-col justify-between">
          ...
          <div className="space-y-3 flex-1 flex flex-col justify-center">
            <button
              ...
              className="w-full flex items-center justify-center gap-2 bg-surface hover:bg-surface-bright border border-outline-variant/40 text-on-surface font-data-sm text-xs font-bold py-2.5 px-4 rounded-lg transition-colors"
            >
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2 bg-surface hover:bg-surface-bright border border-outline-variant/40 text-primary font-data-sm text-xs font-bold py-2.5 px-4 rounded-lg transition-colors"
            >
            ...
            <button
              onClick={logout}
              className="w-full flex items-center justify-center gap-2 bg-error-container text-on-error-container font-data-sm text-xs font-bold py-2.5 px-4 rounded-lg hover:opacity-90 transition-opacity"
            >
