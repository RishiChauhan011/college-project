        ...
        <section className="mb-32 grid grid-cols-1 lg:grid-cols-2 gap-gutter items-center relative">
          ...
          <div className="flex flex-col gap-6 pr-0 lg:pr-12">
            ...
            <div className="flex items-center gap-4 mt-4">
              <button className="bg-primary text-on-primary px-8 py-4 rounded-lg text-data-lg font-data-lg hover:bg-surface-tint hover:scale-95 transition-all duration-200 shadow-lg" onClick={() => navigate('/login')}>
                Get Started
              </button>
              <button className="elevation-1 text-on-surface px-8 py-4 rounded-lg text-data-lg font-data-lg hover:text-primary transition-colors duration-200" onClick={() => navigate('/roadmap')}>
                View Demo Route
              </button>
            </div>
          </div>
          ...
          <div className="relative h-[500px] elevation-1 rounded-2xl p-8 flex flex-col justify-between overflow-hidden bg-surface">
            ...
            <svg className="absolute inset-0 w-full h-full pointer-events-none" preserveAspectRatio="none">
              <path className="opacity-50" d="M 50,400 Q 150,300 200,250 T 400,100" fill="none" stroke="#767586" strokeDasharray="4 4" strokeWidth="2"></path>
            </svg>
            ...
            <div className="relative z-10 self-start mt-auto">
              ...
              <div className="elevation-2-inset px-4 py-3 rounded-lg bg-surface">
                <span className="text-body-md font-body-md font-medium">Backend Developer</span>
              </div>
            </div>

            <div className="relative z-10 self-center absolute top-1/2 left-1/3 -translate-y-1/2">
              ...
              <div className="mt-2 elevation-1 px-3 py-1.5 rounded-md bg-surface text-center">
                <span className="text-data-sm font-data-sm text-on-surface">Python</span>
              </div>
            </div>

            <div className="relative z-10 self-center absolute top-1/3 right-1/3 -translate-y-1/2">
              <div className="w-6 h-6 rounded-full bg-primary flex items-center justify-center waypoint-glow">
                <div className="w-2 h-2 rounded-full bg-on-primary"></div>
              </div>
              <div className="mt-2 elevation-1 px-3 py-1.5 rounded-md bg-surface text-center">
                <span className="text-data-sm font-data-sm text-on-surface">Cloud Arch</span>
              </div>
            </div>

            <div className="relative z-10 self-end mb-auto absolute top-8 right-8">
              ...
              <div className="elevation-1 px-5 py-4 rounded-xl border border-primary-fixed">
                <span className="text-headline-md font-headline-md text-primary font-bold">AI Architect</span>
                <div className="mt-2 flex gap-2">
                  <span className="skill-chip elevation-1 px-2 py-1 rounded text-data-sm font-data-sm text-on-surface-variant">Leadership</span>
                  <span className="skill-chip elevation-1 px-2 py-1 rounded text-data-sm font-data-sm text-on-surface-variant">Strategy</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <footer className="bg-surface-bright mt-auto py-8 border-t border-surface-variant">
        <div className="max-w-container-max mx-auto px-margin-desktop flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-8">
            <Link className="text-body-sm font-body-sm text-on-surface-variant hover:text-primary transition-colors" to="#">About</Link>
            <Link className="text-body-sm font-body-sm text-on-surface-variant hover:text-primary transition-colors" to="#">Contact</Link>
            <Link className="text-body-sm font-body-sm text-on-surface-variant hover:text-primary transition-colors" to="#">Methodology</Link>
          </div>
